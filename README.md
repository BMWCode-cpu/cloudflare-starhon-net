...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/orlando)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/orlando
```

A live public deployment of this template is available at [https://orlando.templates.workers.dev](https://orlando.templates.workers.dev)
